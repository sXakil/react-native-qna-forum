	...
	render() {
		return (
          ...
          <Form autoComplete="off">
              ...
              <Form.Control type="text" placeholder="Title" value={this.state.qnTitle} onChange={this.handleTitleChange} />
						</Form.Group>
						<Form.Group controlId="questionForm.QuestionDescription">
							<Form.Label>Description</Form.Label>
              <Form.Control as="textarea" rows="7" value={this.state.qnDescription} onChange={this.handleDescriptionChange} placeholder="Description" />
            </Form.Group>
